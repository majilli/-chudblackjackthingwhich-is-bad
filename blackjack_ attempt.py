...
if hand == 21:
    ...
    print("You lose! You went over 21.") # The player loses if they bust and go over 21 and the game ends.
    ...
    while dealer_hand < 17:                     # A loop is created so the dealer will keep drawing cards until they reach 17 or higher.
        ...
        dealer_hand += new_card                 # The dealers new and old cards are added togeher so the player knows the dealers new hand.
